...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::list_publish_attribute_suggestions,
            commands::apply_publish_attribute_suggestions,
            commands::run_publish_category_prechecks_once,
            commands::run_publish_asset_uploads_once,
            commands::run_publish_submits_once,
